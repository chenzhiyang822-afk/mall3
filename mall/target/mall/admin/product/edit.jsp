...
<head>
    <meta charset="UTF-8">
    <title>Edit Product - Mall Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/admin/product?action=edit" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" 
                              placeholder="Enter product description"><%= product.getDescription() != null ? product.getDescription() : "" %></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status">
                        <option value="1" <%= product.isOnSale() ? "selected" : "" %>>On Sale</option>
                        <option value="0" <%= !product.isOnSale() ? "selected" : "" %>>Off Sale</option>
                    </select>
                </div>
